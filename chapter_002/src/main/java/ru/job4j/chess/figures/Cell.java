...
/**
 * Перечисление, содержит ячейки шахматной доски.
...
public enum Cell {
    ...
    /**
     * Метод возвращает ячейку с указанными координатами.
     *
     * @param x Координата точки по оси х.
     * @param y * Координата точки по оси у.
     */
    Cell(int x, int y) {
        this.x = x;
        this.y = y;
    ...
    /**
     * Метод возвращает ячейку с заданными координатами.
     *
